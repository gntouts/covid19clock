...
if ( ! class_exists( 'Woostify_Adjacent_Products' ) ) {
	/**
	 * Main class
	 */
	class Woostify_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'woostify_woocommerce_adjacent_query_args', $args ) );
